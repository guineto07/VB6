...
Private Sub DataGrid1_DblClick()
    If DataGrid1.Text <> "" Then
        'Optei utilizar uma classe para retornar os dados do grid ao formulário de cadastro,
        'evitando uma nova requisição ao banco para melhora a performance
        With clsTransacao
...
Private Sub Form_Unload(Cancel As Integer)
    If IsError(clsTransacao.curIdTransacao) Then clsTransacao.curIdTransacao = 0
End Sub
