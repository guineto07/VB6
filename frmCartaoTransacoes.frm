...
Private Sub Limpar()
    ...
    If Not clsTransacao Is Nothing Then
...
Private Sub cmdConsultar_Click()
    ...
    If clsTransacao Is Nothing Then Exit Sub
...
Private Sub cmdConsultarCartao_Click()
    ...
    ConsultaCliente (strNumero_Cartao)
End Sub
...
Private Sub cmdExcluir_Click()
    ...
    clsTransacao.Excluir (clsTransacao.curIdTransacao)
...
Private Sub cmdGravar_Click()
    ...
    If msgPergunta(strMsg) = vbYes Then
         ...
         clsTransacao.Gravar (intAcaoMomento)
    Else
        Exit Sub
    End If
...
On Error GoTo Err_Consulta
    ...
    If Not rsTemp.EOF Then
       ...
       txtValor_Transacao.SetFocus
       txtId_Cliente.Text = rsTemp!Id_Cliente
       
       cmdConsultarCartao.Enabled = False
    Else
       MsgBox "Cliente não encontrado.", vbCritical, "Cadastro de transações"
       If msgPergunta("Deseja cadastrar o Cliente/Cartão?") = vbYes Then
            frmCadClientes.Show 1
            intAcaoMomento = Incluir
            mskNumero_Cartao.SetFocus
       End If
